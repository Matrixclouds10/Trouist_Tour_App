    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(children: [
          CustomTopDetailsStackWidget(isFav: programResponse!.isFav,startDate: programResponse!.startDate!, day: programResponse!.duration, image: programResponse!.images!.map((e) => e.image).toList(),isVideo: programResponse!.images!.map((e) => e.isVideo).toList(), id: programResponse!.id!,),
          verticalSpace(24),
